...
hw7: main.o iterator.o
ifeq (${OS}, Windows_NT)
	g++ -o hw7 main.o iterator.o -lgtest
else
	g++ -o hw7 main.o iterator.o -lgtest -pthread
endif
...
iterator.o: iterator.cpp term.h struct.h list.h iterator.h
